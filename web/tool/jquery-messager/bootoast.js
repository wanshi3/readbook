...
(function($, window, document, undefined) {
        ...
        if (options !== undefined) {
            ...
            if (this.positionSupported[this.settings.position] === undefined) {
                ...
                if (this.positionSinonym[positionCamel] !== undefined) {
                    this.settings.position = this.positionSinonym[positionCamel] || 'bottom-middle';
                }
            }
    ...
    $.extend(BootstrapNotify.prototype, {
         ...
         */
        defaults: {
            message: 'info!', // String: HTML
            type: 'info', // String: ['warning','success','danger','info','dark','light']
            position: 'center-middle', // String: ['top-left', 'top-middle', 'top-right', 'bottom-left', 'bottom-middle', 'bottom-right']
            icon: 'info-sign', // String: name
            timeout: 1000,
