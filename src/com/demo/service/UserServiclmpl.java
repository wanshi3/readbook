...
public class UserServiclmpl implements UserService {
    ...
    //查询业务
    @Override
    public JsonData select(User obj)
    {
    ...
    //删除业务
    @Override
    public JsonData delete(User obj)
    {
        Connection conn = DButil.getConnection();//数据库连接
        UserDAOImpl stuBO = new UserDAOImpl(conn);//业务层对象，用于调用DAO层方法
        try{
     ...
     */
    @Override
    public JsonData update(User obj){
        Connection conn = DButil.getConnection();//数据库连接
        UserDAOImpl bo = new UserDAOImpl(conn);//业务层对象，用于调用DAO层方法
        try{
    ...
    //插入
    @Override
    public JsonData insert(User obj){
        Connection conn = DButil.getConnection();//数据库连接
        UserDAOImpl bookBO = new UserDAOImpl( conn);//业务层对象，用于调用DAO层方法
        try{
